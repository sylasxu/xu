...
>
> **"你想去参加百人徒步，去粗门。你想约几个朋友吃火锅、打麻将、拼个车，用xu。"**
...
>
> **理由**：xu的流量模型是"外部曝光 → 微信内转化"。H5 的核心 KPI 是制造 FOMO（主题背景 + 社交氛围 + 报名人数），激发用户去微信内参与。加 H5 登录态会显著增加复杂度（JWT 管理、手机号验证 UI、非微信用户通知策略），拖慢交付。
>
...
> **核心逻辑**：一个普通用户，最开始是 Joiner（参与者）。他点开了一张精美的邀请函，觉得"这卡片真酷"。当他下次自己想约饭时，如果能想起用xu发一个局，他就完成了从 Joiner 到 Creator 的跃迁。**这是xu最核心的增长引擎：体验即营销。**
