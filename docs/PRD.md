...
> **版本**：v5.3 (Real Social Loop + A2UI + Action-Gated Auth)
> **更新日期**：2026-03-09
> **App 名称**：聚场 (JuChang)
...
| **S2 表达** | “我想找局/找搭子” | Chat Gateway 接收 `text/action` | 输入回显 + 思考气泡 | 成功进入意图识别或 Action 快车道 |
| **S3 理解** | “它懂我在说什么吗” | Intent/P0 热词/Processor 管线 | 精准追问或直接卡片 | 关键信息完整率 ≥ 80% |
| **S4 执行** | “别只说，直接办” | Tool 或 UserAction 执行 | Draft/Explore/Intent 卡片 | 产生可执行 CTA（报名/发布/匹配） |
