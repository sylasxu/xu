...
| `dashboard` | `/dashboard` | 首页数据聚合、God View 实时概览 (BFF 聚合层) |
| `analytics` | `/analytics` | **数据分析**：趋势洞察、内容效果、业务指标 (v5.1 新增) |
...
// Dashboard (v4.5 新增：God View 实时概览，v5.1 重构为 BFF 聚合层)
