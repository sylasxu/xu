...
| `content` | `/content` | **内容运营**：小红书笔记生成、内容库管理、效果追踪 (v5.1 从 Growth 迁移) |
...
- **CP-49**: `find_partner` 提交意向成功后，`agent_tasks.partnerIntentId` 必须与真实写入的 `partner_intents.id` 一致
