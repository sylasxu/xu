...
const scenarioMatrixEntries: ScenarioMatrixEntry[] = [
  ...
  },
  {
    ...
    primarySurface: 'api',
    scenarioType: 'guardrail',
    userMindsets: ['privacy_cautious'],
    trustRisks: ['memory_pollution', 'privacy_exposure'],
    dropOffPoints: ['long_conversation'],
    expectedFeeling: '临时聊天不会污染长期画像，真实结果才进记忆',
    longFlowIds: ['LF-5'],
  },
  {
    id: 'five-user-smoke',
    ...
    primarySurface: 'shared',
    scenarioType: 'happy_path',
    userMindsets: ['post_join_empty', 'trust_building'],
    trustRisks: ['dead_air', 'state_confusion'],
    dropOffPoints: ['discussion'],
    expectedFeeling: '多用户小范围跑通，不只单人自测通过',
    longFlowIds: ['LF-8'],
